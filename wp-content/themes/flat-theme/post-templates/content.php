...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        <?php the_content( __( '<br><br><img src="http://localhost/PaulaFerracini/app/WordPress-4.3.1/wp-content/themes/flat-theme/assets/images/img/btn-leiamais.jpg" />', ZEETEXTDOMAIN ) ); ?>
    </div>
    <?php } //.entry-content ?>
